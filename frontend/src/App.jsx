...
import { mergeImportedCourses, currentYearKey } from "./transcript-utils.js";
...
import { fitReadIsStale } from "./fit-refresh.js";
import { serverDateToISO } from "./dates.js";
import { TEST_SCORE_LIMITS, validateTestEntry, blankTestForm, entryToForm, formToEntry } from "./test-scores.js";
import "./strategy-council.js";
...
import { encrypt, storageApi, safeBtoa, storageKeyFor, clearSession, buildVaultBlob } from "./vault-storage.js";
import { ONBOARDING_CONSENT_TYPES, grantOnboardingConsents, sessionTimer } from "./server-session.js";
import "./profile-analysis.js";
import { MAX_SCHOOL_FILE_SIZE_BYTES, resolveUploadMimeType, getSchoolFileValidationError } from "./chat-files.js";
import { rateLimiter, setReauthListener, setReauthCredentialProvider, _tryReAuth } from "./chat-client.js";
import "./markdown.jsx";
import "./chat-orchestrator.js";
import ChatScreen from "./ChatScreen.jsx";
import { send as sendImpl, handleChatFilesSelect as handleChatFilesSelectImpl, openThread as openThreadImpl, persistTurn as persistTurnImpl } from "./chat-send.js";
import { handleLogin as handleLoginImpl, handleCreate as handleCreateImpl, handleStudentRecovery as handleStudentRecoveryImpl } from "./auth-handlers.js";
import { handleSurveyComplete as handleSurveyCompleteImpl, hydrateSurveyFromCurrentData as hydrateSurveyFromCurrentDataImpl, reconcileWithBackendProfile as reconcileWithBackendProfileImpl, editECFromProfile as editECFromProfileImpl } from "./survey-handlers.js";
import { createDeadlinesForSchool as createDeadlinesForSchoolImpl, lookupCollege as lookupCollegeImpl, removeTargetSchool as removeTargetSchoolImpl, conveneStrategyCouncil as conveneStrategyCouncilImpl } from "./school-handlers.js";

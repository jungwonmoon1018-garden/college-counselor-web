...
export const STRINGS = {
  "en-US": {
    ...
    "candidates.ranking_elapsed": "Ranking… {seconds}s",
    "candidates.timeout": "Ranking took too long and was stopped. The quick ranking usually returns within half a minute — try again.",
    "candidates.retry": "Retry",
    "candidates.no_narrative_cta": "Write your narrative first",
    "candidates.empty": "Add at least one idea above.",
    "drift.write_story": "Write your story",
    ...
    "fit.verify": "🔎 Double-check with the web",
    "fit.verifying": "Checking live sources…",
    "fit.verdict_consistent": "Consistent with live sources",
    "fit.verdict_discrepancies_found": "Live sources differ from the stored data",
    "fit.verdict_inconclusive": "Official pages inconclusive",
    "fit.verdict_unverifiable": "Couldn't verify against live sources",
    "fit.recomputed": "With live inputs",
    "fit.model_review": "Second read of the official pages",
    "fit.fit_used": "fit used",
    "fit.live": "live",
    "fit.compare": "How your record compares",
    "fit.cmp_tests": "Tests",
    "fit.cmp_gpa": "GPA",
    "fit.cmp_rank": "Class rank",
    "fit.cmp_ap": "AP exams",
    "fit.cmp_average": "average",
    "fit.cmp_weighted": "weighted",
    "fit.cmp_band": "middle 50%",
    "fit.cmp_top": "top",
    "fit.cmp_ap_exams": "exams",
    "fit.cmp_ap_relevant": "in your field:",
    "fit.pos_above": "at or above the 75th percentile",
    "fit.pos_within": "inside the middle 50%",
    "fit.pos_below": "below the 25th percentile",
    "fit.pos_unknown": "no band to compare",
    "fit.cmp_distribution": "{shareInBand}% of enrolled submitters scored {band}",
    "fit.cmp_gpa_placement": "{above}% of the enrolled class had a GPA above your {band} band",
    "fit.cmp_rank_school": "{tenth}% of the enrolled class ranked in the top tenth",
    "fit.advice_withhold": "Test-optional here: this score is below the 25th percentile, so consider applying without it.",
    "fit.advice_borderline": "Test-optional here: this score is inside the band but not strong; submitting is a judgment call.",
    "fit.cmp_no_tests": "no score on file (tests are required or considered here)",
    "fit.cmp_no_tests_optional": "no score on file (test-optional here)",
    "fit.hits_one": "✓ 1 match",
    "fit.hits_many": "✓ {n} matches",
    "fit.no_match": "no profile match",
    "fit.below_range": "on file, but below range here",
    "fit.not_readable": "not read from your profile",
    "fit.interest_note": "This school weighs demonstrated interest — campus visits, info sessions and an early application are how it's shown.",
    "fit.withhold_short": "consider withholding",
    "fit.trait_leadership": "leadership",
    "fit.trait_character": "character",
    "fit.trait_talent": "talent",
    "fit.trait_commitment": "commitment",
    "fit.trait_impact": "impact",
    "fit.trait_major_focus": "major focus",
  ...
  "ko": {
    ...
    "candidates.ranking_elapsed": "\uc21c\uc704 \uc0b0\uc815 \uc911\u2026 {seconds}\ucd08",
    "candidates.timeout": "\uc21c\uc704 \uc0b0\uc815\uc774 \ub108\ubb34 \uc624\ub798 \uac78\ub824 \uc911\ub2e8\ub418\uc5c8\uc2b5\ub2c8\ub2e4. \ube60\ub978 \uc21c\uc704\ub294 \ubcf4\ud1b5 30\ucd08 \uc548\uc5d0 \ub3cc\uc544\uc624\ub2c8 \ub2e4\uc2dc \uc2dc\ub3c4\ud574\uc8fc\uc138\uc694.",
    "candidates.retry": "\ub2e4\uc2dc \uc2dc\ub3c4",
    "drift.write_story": "\ub0b4 \uc774\uc57c\uae30 \uc791\uc131\ud558\uae30",
    ...
    "fit.verify": "🔎 웹으로 다시 확인",
    "fit.verifying": "실시간 출처 확인 중…",
    "fit.verdict_consistent": "실시간 출처와 일치",
    "fit.verdict_discrepancies_found": "실시간 출처가 저장된 데이터와 다름",
    "fit.verdict_inconclusive": "공식 페이지에서 확정 불가",
    "fit.verdict_unverifiable": "실시간 출처로 확인할 수 없음",
    "fit.recomputed": "실시간 입력값 기준",
    "fit.model_review": "공식 페이지 2차 판독",
    "fit.fit_used": "적합도 계산값",
    "fit.live": "실시간",
    "fit.compare": "내 기록과의 비교",
    "fit.cmp_tests": "시험 점수",
    "fit.cmp_gpa": "GPA",
    "fit.cmp_rank": "학급 석차",
    "fit.cmp_ap": "AP 시험",
    ...
    "fit.cmp_top": "상위",
    "fit.cmp_ap_exams": "개",
    "fit.cmp_ap_relevant": "지망 분야:",
    "fit.pos_above": "75퍼센타일 이상",
    "fit.pos_within": "중간 50% 이내",
    "fit.pos_below": "25퍼센타일 미만",
    "fit.pos_unknown": "비교할 구간 없음",
    "fit.cmp_distribution": "재학생 제출자의 {shareInBand}%가 {band}점대",
    "fit.cmp_gpa_placement": "재학생의 {above}%가 내 {band} 구간보다 높은 GPA",
    "fit.cmp_rank_school": "재학생의 {tenth}%가 상위 10% 출신",
    "fit.advice_withhold": "테스트 옵셔널: 이 점수는 25퍼센타일 미만이므로 제출하지 않고 지원하는 것을 고려하세요.",
    "fit.advice_borderline": "테스트 옵셔널: 구간 안이지만 강하지 않아 제출 여부는 판단이 필요합니다.",
    "fit.cmp_no_tests": "기록된 점수 없음 (이 학교는 시험 점수를 요구하거나 고려)",
    "fit.cmp_no_tests_optional": "기록된 점수 없음 (테스트 옵셔널)",
    "fit.hits_one": "✓ 1개 일치",
    "fit.hits_many": "✓ {n}개 일치",
    "fit.no_match": "프로필에 일치 항목 없음",
    "fit.below_range": "기록은 있지만 이 학교 범위 아래",
    "fit.not_readable": "프로필로는 읽을 수 없음",
    "fit.interest_note": "이 학교는 지원자의 관심도를 봅니다. 캠퍼스 방문, 설명회 참석, 조기 지원으로 보여 줄 수 있어요.",
    "fit.withhold_short": "제출 보류 고려",
    "fit.trait_leadership": "리더십",
    "fit.trait_character": "인성",
    "fit.trait_talent": "재능",
    "fit.trait_commitment": "꾸준함",
    "fit.trait_impact": "영향력",
    "fit.trait_major_focus": "전공 집중",

...
export const STRINGS = {
  "en-US": {
    ...
    "fit.cmp_rigor": "Course rigor",
    "fit.cmp_rigor_expected": "about {n} college-level courses expected here",
    "fit.rigor_ap": "{n} AP",
    "fit.rigor_ap_scored": "{n} with exam scores",
    "fit.rigor_ib": "{n} IB",
    "fit.rigor_dual": "{n} dual enrollment",
    "fit.rigor_alevel": "{n} A-Level",
    "fit.rigor_honors": "{n} honors",
    "fit.rigor_above": "at or above that load",
    "fit.rigor_within": "close to it",
    "fit.rigor_below": "below it",
    "fit.refreshed": "Re-read after your profile changed",
  ...
  "ko": {
    ...
    "fit.cmp_rigor": "수강 난이도",
    "fit.cmp_rigor_expected": "이 학교 기준 대학 수준 과목 약 {n}개 기대",
    "fit.rigor_ap": "AP {n}개",
    "fit.rigor_ap_scored": "시험 점수 있음 {n}개",
    "fit.rigor_ib": "IB {n}개",
    "fit.rigor_dual": "이중 등록 {n}개",
    "fit.rigor_alevel": "A-Level {n}개",
    "fit.rigor_honors": "아너스 {n}개",
    "fit.rigor_above": "기대 수준 이상",
    "fit.rigor_within": "기대 수준에 근접",
    "fit.rigor_below": "기대 수준 미만",
    "fit.refreshed": "프로필 변경 후 다시 읽음",
